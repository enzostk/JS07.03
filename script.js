...
// // Fonctionnalité 5 :
const headerEl = document.querySelector('div.navbar');
...
// // Fonctionnalité 6:
const viewCard = document.getElementsByClassName("btn-success");
...
const buttonEl1 = document.querySelector('section .btn-secondary');
buttonEl1.addEventListener('click', function (event) {
    event.preventDefault();
    parent.insertBefore(parent.lastElementChild, parent.firstElementChild);
});

// Fonct 8
const buttonEl2 = document.querySelector('section .btn-primary');
buttonEl2.removeAttribute('href');
